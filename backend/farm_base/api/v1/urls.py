...
urlpatterns = [
    path("farms", FarmListCreateView.as_view(), name="farms-list-create"),
    path(
        "farms/<int:pk>",
        FarmRetrieveUpdateDestroyView.as_view(),
        name="farms-retrieve-update-destroy",
    ),
    path("owners", OwnerListCreateView.as_view(), name="owners-list-create"),
    path(
        "owners/<int:pk>",
